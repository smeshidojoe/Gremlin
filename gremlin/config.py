...
GAME_BITS = (
    ...
    (GAME_COURT, "Народный суд", "!суд ответом",
     "Чат минуту голосует кнопками «Виновен / Невиновен». Нужно минимум три "
     "голоса; если виновных больше — приз обвиняемому, иначе оправдание. "
     "Подсудимый за себя не голосует."),
...
COURT_VOTE = 60
COURT_MIN_VOTES = 3       # меньше — приговор не выносим
