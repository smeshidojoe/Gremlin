...
COLUMNS = [
    ...
    ("role", "Роль", 18),
    ("joined", "Вступил", 12),
    ("days_in_chat", "Дней в чате", 12),
    ("msgs", "Всего сообщений", 16),
    ("first_msg", "Первое сообщение", 16),
    ("last_msg", "Последнее сообщение", 18),
    ("days_silent", "Дней молчит", 12),
    ("active_days", "Активных дней", 14),
    ("m7", "За 7 дн.", 10),
    ("m30", "За 30 дн.", 10),
    ("m90", "За 90 дн.", 10),
    ("media", "Медиа", 9),
    ("replies", "Ответов", 10),
    ("reactions", "Реакций получено", 17),
    ("avg_len", "Ср. длина", 11),
    ("last_online", "Был в сети", 22),
    ("last_link", "Ссылка", 34),
]
